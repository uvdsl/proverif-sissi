...
---|---|---|---|---|---
|||||
[Plain VCs](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/) | Secrecy | 1 | [sissi.pv#L287](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi.pv#L287) |  [x]  | [ ]
 | | | 2 | [archive/sissi_forward_secrecy.pv](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/archive/sissi_forward_secrecy.pv) |  [x]  | [ ]
 | | Agreement | 3 | [sissi.pv#L309](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi.pv#L309) |  [x]  | [ ]
 | | | 4 | [sissi_ok_VP_leaked.pv](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi_ok_VP_leaked.pv) |  [x]  | [ ]
 | | | 5 | [sissi_unforgeable_VC.pv](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi_unforgeable_VC.pv) |  [x]  | [ ]
| | | 6 | [sissi_attack_domain_missing_replay.pv](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi_attack_domain_missing_replay.pv) |  [ ] | [x] 
| | | 7 | [sissi_attack_no_nonce_VP_leaked.pv](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi_attack_no_nonce_VP_leaked.pv) |  [ ] | [x] 
| | | 8 | [sissi_attack_VC_reissued.pv](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi_attack_VC_reissued.pv) |  [ ] | [x] 
| | Unlinkability | 9 | [sissi_unlinkable.dps](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi_unlinkable.dps) |  [x]  | [ ]
| | | 10 | [sissi_attack_verifier_unlinkablity.dps](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi_attack_verifier_unlinkablity.dps) |  [ ] | [x] 
|||||
[Anon VCs](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm/) | Secrecy | 11 | [sissi.pv#L297](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm/sissi.pv#L297) |  [x]  | [ ]
 | | Agreement | 12 | [sissi.pv#L319](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm/sissi.pv#L319) |  [x]  | [ ]
| | Unlinkability | 13 | [sissi_unlinkablity_ok_wrt_verifier.dps](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm/sissi_unlinkablity_ok_wrt_verifier.dps) |  [x]  | [ ]
|||||
[Plain VCs + Diffie-Hellman](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm%2BDH/) | Secrecy | 14 | [sissi.pv#L302](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm%2BDH/sissi.pv#L302) |  [x]  | [ ]
 | | Agreement | 15 | [sissi.pv#L324](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm%2BDH/sissi.pv#L324) |  [x]  | [ ]
|||||
[Anon VCs + Diffie-Hellmann](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm%2BDH/) | Secrecy | 16 | [sissi.pv#L312](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm%2BDH/sissi.pv#L312) |  [x]  | [ ]
 | | Agreement | 17 | [sissi.pv#L334](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm%2BDH/sissi.pv#L334) |  [x]  | [ ]
|||||

For a description of the potential attacks when deviating from the protocol, visit the [Plain VCs](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/) parent directory.

For more detailled information, visit the corresponding "protocol directories", i.e., 
- [Plain VCs](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/) for an instance of the protocol using plain/simple Verifiable Credentials (VCs) and DIDComm (which is typically the instance of the protocol we refer to), 
- [Anon VCs](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm/) for an instance of the protocol using anonymous credentials and DIDComm, 
- [Plain VCs + Diffie-Hellmann](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm%2BDH/) for an instance of the protocol using plain/simple Verifiable Credentials (VCs) and a Diffie-Hellmann handshake, and 
- [Anon VCs + Diffie-Hellmann](https://github.com/uvdsl/proverif-sissi/tree/main/AnonVCs/DIDComm%2BDH/) for an instance of the protocol using anonymous credentials and a Diffie-Hellmann handshake.
...
Find a Message Sequence Chart (MSC) of the plain model [here](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/doc/msc-full-protocol.pdf).

Here, we give the corresponding formal model (cf. [Proverif code](https://github.com/uvdsl/proverif-sissi/tree/main/PlainVCs/DIDComm/sissi.pv)):
